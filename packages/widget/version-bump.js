...
const versionType = args[0]; // 'patch', 'minor', or 'major'

if (!versionType || !['patch', 'minor', 'major'].includes(versionType)) {
  console.log('Usage: node version-bump.js [patch|minor|major]');
  console.log('');
  console.log('Examples:');
  console.log('  node version-bump.js patch  # 1.0.0 -> 1.0.1 (bug fixes)');
  console.log('  node version-bump.js minor  # 1.0.0 -> 1.1.0 (new features)');
  console.log('  node version-bump.js major  # 1.0.0 -> 2.0.0 (breaking changes)');
  process.exit(1);
}
