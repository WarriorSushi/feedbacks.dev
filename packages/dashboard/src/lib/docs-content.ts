...
export const DOCS_PAGES: DocsPage[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'paragraph', text: 'Pro accounts can receive board-level follower updates plus watched-request status changes and official team replies. Notification fanout excludes the actor and deduplicates recipients. Free accounts can still follow, watch, and review activity on the board without email alerts.' },
...
FEEDBACKS_API_URL=https://app.feedbacks.dev` },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'paragraph', text: 'Project count, monthly feedback, email alerts, webhook delivery logs, update analytics, branding, and other entitlements depend on the current plan. Email alerts and daily feedback digests require Pro. Billing and the project workspace show the active limits before an action is blocked. Full feedback history is available on both Free and Pro.' },
