          ...
          {SECTION_TABS.map((tab) => {
            ...
            return (
              <Button
                ...
                className={cn(
                  'relative h-9 min-w-0 justify-center rounded-md border px-1 text-[10px] font-semibold uppercase tracking-[0.14em] transition-all duration-150',
                  isActive
                ...
                {WIDGET_SUB_STEPS.map((step, index) => {
                  ...
                  return (
                    <Button
                      ...
                      variant="ghost"
                      className={cn(
                        'h-12 min-w-0 flex-col items-center justify-center gap-1 rounded-lg border px-1 text-[10px] font-medium tracking-[0.08em] transition-colors',
                        isStepActive
