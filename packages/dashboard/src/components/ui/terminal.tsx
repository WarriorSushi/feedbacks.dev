...
export function Terminal({
  ...
  return (
    ...
    >
      <div className="overflow-hidden rounded-xl border border-zinc-800/80 bg-zinc-950 shadow-2xl shadow-black/20">
        {/* Title Bar */}
        <div className="flex items-center gap-2 border-b border-zinc-800/80 bg-zinc-900 px-4 py-3">
        ...
        <div
          ref={contentRef}
          className="no-visible-scrollbar h-80 overflow-y-auto bg-[linear-gradient(180deg,rgba(24,24,27,0.82),rgba(9,9,11,1))] p-4 font-mono"
        >
          {lines.map((line, i) => (
          ...
          {phase === 'typing' && (
            <div className="leading-relaxed whitespace-pre-wrap">
              ...
              <span className="ml-0.5 inline-block h-4 w-2 bg-zinc-200 align-middle" />
            </div>
          )}
          ...
          {(phase === 'done' ||
            ...
            <div className="leading-relaxed whitespace-pre-wrap">
              ...
              <span
                className={cn(
                  'inline-block h-4 w-2 bg-zinc-200 align-middle transition-opacity duration-100',
