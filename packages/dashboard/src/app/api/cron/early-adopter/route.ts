...
import { processEarlyAdopterLifecycle } from '@/lib/early-adopter-lifecycle'
...
export async function GET(request: NextRequest) {
  ...
  try {
    cronRunId = await startCronRun(admin, 'early_adopter_lifecycle')
    const result = await processEarlyAdopterLifecycle()
