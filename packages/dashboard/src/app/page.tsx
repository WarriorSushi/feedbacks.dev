  ...
  return (
    <div className="marketing-shell min-h-screen bg-background text-foreground">
      ...
      <main>
        ...
        <section className="landing-proof-strip landing-atmosphere-section landing-tone-quiet landing-reveal relative border-b py-6 sm:py-8">
        ...
        <section id="pricing" className="landing-pricing-section landing-atmosphere-section landing-tone-pricing landing-reveal relative overflow-hidden border-b py-20 sm:py-28">
