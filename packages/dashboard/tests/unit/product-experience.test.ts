...
test('landing page explains both sides of the feedback loop and keeps the install-once architecture', () => {
  ...
  assert.match(hero, /const \[completed, setCompleted\]/)
  assert.match(hero, /const peekTop = heroTop \+ \(productTop - heroTop\) \* 0\.52/)
  assert.match(hero, /animateWindowScroll\(peekTop, 900, signal\)/)
  assert.match(hero, /animateWindowScroll\(heroTop, 1_100, signal\)/)
