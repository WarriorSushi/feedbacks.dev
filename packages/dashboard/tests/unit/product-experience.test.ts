...
test('landing page explains both sides of the feedback loop and keeps the install-once architecture', () => {
  ...
  assert.match(source, /Install it once\. See the first report arrive\./)
  ...
  assert.match(install, /Paste one snippet/)
  assert.match(install, /Send one real test/)
  assert.match(install, /Change it without reinstalling/)
  assert.match(install, /Private credentials stay server-side/)
  assert.match(install, /landing-product-cinema/)
  assert.match(install, /IntersectionObserver/)
  assert.match(install, /prefers-reduced-motion/)
  assert.match(install, /Pause product walkthrough/)
  assert.match(install, /setTimeout/)
