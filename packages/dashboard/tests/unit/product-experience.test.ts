...
test('landing page explains both sides of the feedback loop and keeps the install-once architecture', () => {
  ...
  const beams = read('../../src/components/landing-background-beams.tsx')
  ...
  assert.match(hero, /const easeOutExpo/)
  assert.match(hero, /const peekTop = heroTop \+ \(productTop - heroTop\) \* 0\.5/)
  assert.match(hero, /window\.scrollTo\(\{ top: peekTop, left: 0, behavior: 'auto' \}\)/)
  ...
  assert.match(css, /@keyframes landing-beam-travel/)
  assert.match(css, /prefers-reduced-motion: reduce/)
  assert.match(beams, /beamPaths/)
  assert.match(beams, /landing-beam-energy-paths/)
  ...
  assert.match(css, /\.windows98 \.landing-background-beams[\s\S]*display: none/)
