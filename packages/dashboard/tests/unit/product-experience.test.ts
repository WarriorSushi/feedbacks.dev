...
test('landing page explains both sides of the feedback loop and keeps the install-once architecture', () => {
  ...
  assert.match(source, /One short path to a message you can act on\./)
  assert.match(source, /Installed code stays stable\./)
  ...
  assert.doesNotMatch(source, /LandingFeedbackStory|LandingInstallStory|WidgetDemo/)
