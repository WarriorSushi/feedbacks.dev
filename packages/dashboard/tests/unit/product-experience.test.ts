...
test('authenticated dashboard dogfoods the feedback widget through the account menu', () => {
  ...
  assert.match(sidebar, /FEEDBACKS_CONFIGURATION_EVENT/)
  assert.match(sidebar, /detail\.embedMode !== 'inline'/)
  assert.match(sidebar, /showFeedbackMenuItem \? \(/)
  assert.match(widget, /window\.addEventListener\('feedbacks:open'/)
  assert.match(widget, /FEEDBACKS_CONFIG_UPDATE_EVENT/)
  assert.match(widget, /this\.manualPresentation && this\.cfg\.embedMode !== 'inline'/)
  assert.match(widget, /if \(this\.cfg\.embedMode === 'inline'\) return/)
