...
test('sign-in stays concise while showing the rotating use-case carousel', () => {
  ...
  assert.match(carousel, /Reproduce bugs faster/)
  assert.match(carousel, /Choose the next useful bet/)
  assert.match(carousel, /Close the loop/)
  assert.match(carousel, /Install once\. Change the workflow/)
