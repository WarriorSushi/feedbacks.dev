...
const requiredColumns = {
  ...
  early_adopter_programmes: ['id', 'capacity', 'enrolment_open', 'created_at', 'updated_at'],
  early_adopter_memberships: ['id', 'user_id', 'email', 'email_hash', 'seat_number', 'status', 'onboarding_completed_at', 'pro_months_earned', 'feedback_opens_at', 'feedback_due_at', 'grace_ends_at', 'programme_expires_at', 'programme_ends_at', 'completed_at', 'removed_at'],
  early_adopter_feedback: ['id', 'membership_id', 'cycle_number', 'good', 'bad', 'improve', 'anything_else', 'submitted_at'],
  early_adopter_notices: ['id', 'membership_id', 'cycle_number', 'notice_type', 'sent_at'],
