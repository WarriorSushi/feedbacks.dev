...
function feedbacks_assets() {
  wp_enqueue_style('feedbacks-css', 'https://app.feedbacks.dev/cdn/widget/latest.css');
  wp_enqueue_script('feedbacks-js', 'https://app.feedbacks.dev/cdn/widget/latest.js', array(), null, true);
  wp_add_inline_script('feedbacks-js', 'new FeedbacksWidget({ projectKey: "feedbacks_dev_api_key_abc123", embedMode: "modal" });');
}
