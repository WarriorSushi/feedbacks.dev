# feedbacks.dev - Instructions for Codex CLI
...
pnpm dev                   # Start the dashboard workspace
pnpm build                 # Build for production
pnpm type-check            # TypeScript validation

# Widget-specific
pnpm widget:dev            # Widget dev server (port 3001)
pnpm widget:build          # Build widget for CDN

# Dashboard-specific
pnpm dashboard:dev         # Dashboard dev server (port 3000)
